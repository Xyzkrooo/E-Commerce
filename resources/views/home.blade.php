                                ...
                                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    ...
                                                    <img class="product_hover_img"
                                                        src="{{ 'user/assets/images/el_hover_img2.jpg' }}"
                                                        alt="el_hover_img2">
                                                </a>
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    ...
                                                    <img class="product_hover_img"
                                                        src="{{ 'user/assets/images/el_hover_img5.jpg' }}"
                                                        alt="el_hover_img5">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    ...
                                                    <img class="product_hover_img"
                                                        src="{{ 'user/assets/images/el_hover_img9.jpg' }}"
                                                        alt="el_hover_img9">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    ...
                                                    <img class="product_hover_img"
                                                        src="{{ 'user/assets/images/el_hover_img7.jpg' }}"
                                                        alt="el_hover_img7">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ 'user/assets/images/el_img12.jpg' }}"
                                                        alt="el_img12">
                                                    <img class="product_hover_img"
                                                        src="{{ 'user/assets/images/el_hover_img12.jpg' }}"
                                                        alt="el_hover_img12">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
