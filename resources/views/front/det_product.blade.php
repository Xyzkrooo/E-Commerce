                                ...
                                <ul class="list_none comment_list mt-4">
                                    <li>
                                        <div class="comment_img">
                                            <img src="{{asset('user/assets/images/user1.jpg')}}" alt="user1"/>
                                        </div>
                                    ...
                                    <li>
                                        <div class="comment_img">
                                            <img src="{{asset('user/assets/images/user2.jpg')}}" alt="user2"/>
                                        </div>
                                        <div class="comment_block">
                                            <div class="rating_wrap">
                                                <div class="rating">
                                            ...
                                            <div class="product_action_box">
                                                <ul class="list_none pr_action_btn">
                                                    ...
                                                    <form action="{{ route('cart.add', $product->id) }}" method="POST">
                                                        @csrf
                                                        <a href="{{ route('cart.add', $product->id) }}"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                                    </form>
